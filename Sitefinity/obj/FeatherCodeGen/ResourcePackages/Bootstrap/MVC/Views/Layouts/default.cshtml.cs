...
WriteLiteral("\n");
   ...
   Write(Html.Script(ScriptRef.MicrosoftAjax, "top", true));
   ...
   Write(Html.Script(ScriptRef.MicrosoftAjaxCore, "top", true));
   ...
   Write(Html.Script(Url.EmbeddedResource("Telerik.Sitefinity.Resources.Reference", "Telerik.Sitefinity.Resources.Scripts.jquery.ba-outside-events.min.js"), "top", true));
   ...
   Write(Html.Script(ScriptRef.KendoAll, "top", true));
   ...
   Write(Html.Script(ScriptRef.KendoTimezones, "top", true));
   ...
   Write(Html.Script(Url.EmbeddedResource("Telerik.Sitefinity.Resources.Reference", "Telerik.Sitefinity.Resources.Scripts.RequireJS.require.min.js"), "top", true));
