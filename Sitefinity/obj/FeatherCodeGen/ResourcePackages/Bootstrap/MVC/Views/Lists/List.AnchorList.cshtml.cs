...
WriteAttribute("href", Tuple.Create(" href=\"", 1975), Tuple.Create("\"", 2002)
, Tuple.Create(Tuple.Create("", 1982), Tuple.Create("#", 1982), true)
            
            #line 46 "..\..MVC\Views\Lists\List.AnchorList.cshtml"
, Tuple.Create(Tuple.Create("", 1983), Tuple.Create<System.Object, System.Int32>(item.Fields.Id
            
            #line default
            #line hidden
, 1983), false)
, Tuple.Create(Tuple.Create("", 1998), Tuple.Create("-Top", 1998), true)
);
